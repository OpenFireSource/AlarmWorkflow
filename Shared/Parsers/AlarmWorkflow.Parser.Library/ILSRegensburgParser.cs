...
namespace AlarmWorkflow.Parser.ILSRegensburgParser
{
    ...
    public class ILSRegensburgParser : IParser
    {
        ...
        private readonly string[] _keywords = new[]
            {
                "Einsatznummer", "Name", "Straﬂe", "Abschnitt", "Ort",
                "Gemeinde", "Kreuzung", "Objekt", "Schlagw.",
                "Stichwort", "Prio.", "Alarmiert", "gef. Ger‰t"
            };
                        ...
                        case CurrentSection.EEinsatzmittel:
                            {
                                ...
                                else if (line.StartsWith("GEF. GERƒT", StringComparison.CurrentCultureIgnoreCase))
                                {
                                    msg = GetMessageText(line, "GEF. GERƒT");
        ...
        private bool GetSection(String line, ref CurrentSection section, ref bool keywordsOnly)
        {
            ...
            if (line.Contains("ENDE ALARMFAX ó V2.0"))
            {
