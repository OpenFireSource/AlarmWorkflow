                        ...
                        case CurrentSection.EEinsatzgrund:
                            {
                                switch (prefix)
                                {
                                    ...
                                    case "STICHWORT B":
                                        ...
                                        operation.Keywords.R = ParserUtility.GetMessageText(msg.Substring(msg.IndexOf("STICHWORT RD:", StringComparison.InvariantCultureIgnoreCase)), "STICHWORT RD");
                                        break;
                                    case "STICHWORT SO":
                                        operation.Keywords.S = msg.Substring(0, msg.IndexOf("STICHWORT TH:", StringComparison.InvariantCultureIgnoreCase)).Trim();
                                        operation.Keywords.T = ParserUtility.GetMessageText(msg.Substring(msg.IndexOf("STICHWORT TH:", StringComparison.InvariantCultureIgnoreCase), msg.IndexOf("STICHWORT IN:", StringComparison.InvariantCultureIgnoreCase)), "STICHWORT TH:");
                                        operation.CustomData["Stichwort IN"] = ParserUtility.GetMessageText(msg.Substring(msg.IndexOf("STICHWORT IN", StringComparison.InvariantCultureIgnoreCase)), "STICHWORT IN");
                                        break;
                        ...
                        case CurrentSection.FEinsatzmittel:
                            {
                                ...
                                {
                                    msg = ParserUtility.GetMessageText(line, "EINSATZMITTELNAME");
                                    last.FullName = msg.Trim();
                                }
                                else if (line.StartsWith("GEF. GERÄTE", StringComparison.CurrentCultureIgnoreCase))
                                {
                                    msg = ParserUtility.GetMessageText(line, "GEF. GERÄTE");
