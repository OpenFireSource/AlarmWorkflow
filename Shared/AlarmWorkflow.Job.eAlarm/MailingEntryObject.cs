...
{
    internal class MailingEntryObject
    {
        ...
        {
            var returnValue = new MailingEntryObject();
            ...
            var receiptTypeEnum = ReceiptType.To;
        ...
        private static MailAddress TryParseMailAddress(string address)
        {
            ...
            {
                // Parsing failed
                Logger.Instance.LogFormat(LogType.Warning, null,
                                          "The address '{0}' failed to parse. This is usually an indication that the E-Mail address is invalid formatted.",
                                          address);
            }
            return null;
        }
