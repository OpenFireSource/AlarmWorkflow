...
CREATE  TABLE IF NOT EXISTS `alarmworkflow`.`operation` (
  ...
  `keywordmisc` VARCHAR(100) NULL DEFAULT NULL ,
  `keywordb` VARCHAR(100) NULL DEFAULT NULL ,
  `keywordr` VARCHAR(100) NULL DEFAULT NULL ,
  `keywords` VARCHAR(100) NULL DEFAULT NULL ,
  `keywordt` VARCHAR(100) NULL DEFAULT NULL ,
