// <copyright file="WorkingThread.cs" company="OpenFireSource.de">
...
// <summary>This file implements the WorkingThread class.</summary>
namespace OpenFireSource.Alarmworkflow.AlarmworkflowCodeLib
{
	...
	internal class WorkingThread : IDisposable
	{
		...
		internal void _fileSystemWatcher_Created(object sender, FileSystemEventArgs e)
		{
			...
			Einsatz einsatz = this.parser.ParseEinsatz(this.analysisPath + analyseFileName + ".txt");
