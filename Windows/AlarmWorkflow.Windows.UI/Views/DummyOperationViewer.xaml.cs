...
{
    /// <summary>
    /// Interaction logic for DummyOperationViewer.xaml
    /// </summary>
    internal partial class DummyOperationViewer : UserControl, IOperationViewer
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the <see cref="DummyOperationViewer"/> class.
        /// </summary>
        public DummyOperationViewer()
        {
            InitializeComponent();
        }
